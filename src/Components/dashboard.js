...
const navigation = [
  ...
  { name: 'Clients', href: '/Projects' , icon: UsersIcon, current: false },
  { name: 'Calendar', href: '/Calendar', icon: CalendarIcon, current: false },
  { name: 'Reports', href: '/Reports', icon: FolderIcon, current: false },
  { name: 'Gmail', href: '/Gmail', icon: InboxIcon, current: false },
...
const Dashboard = (props) => {
  ...
  let [pathname, setPathname] = useState("");  useEffect(() => {
          ...
          <div className="flex-1 flex flex-col min-h-0 bg-gray-800">
            <div className="flex items-center h-16 flex-shrink-0 px-4 bg-gray-900">
              <img
                ...
                alt="Workflow"
              /> 
              <h1 className='text-white pl-6 text-2xl'>Google Lab</h1>
            </div>
